        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-sm w-full">
            ...
            <div className="mb-6 text-center">
              ...
              <p className="text-gray-600 mb-4">Start automating your business with AI agents - no credit card required</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* Confirm Password Field - appears when password field has content */}
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                Already have an account? <Link href="/login" className="text-primary-600 hover:text-primary-500">Log in</Link>
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="lg:hidden min-h-screen flex items-center justify-center px-4 relative z-10">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-6 w-full max-w-sm border border-white/20">
          ...
          <div className="mb-6 text-center">
            ...
            <p className="text-gray-600 mb-4 text-sm">Start automating your business with AI agents - no credit card required</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Name Field */}
              <div>
                <label htmlFor="name-mobile" className="block text-sm font-medium text-gray-800 mb-2">
                  Full Name
                </label>
                <input
                  id="name-mobile"
              ...
              {formData.password.length > 0 && (
                <div>
                  <label htmlFor="confirmPassword-mobile" className="block text-sm font-medium text-gray-800 mb-2">
                    Confirm Password
                  </label>
                  <input
